...
# Load models
random_forest <- readRDS("models/trained/random_forest.rds")
xgboost <- readRDS("models/trained/xgboost.rds")
plsda <- readRDS("models/trained/plsda.rds")
glmnet <- readRDS("models/trained/glmnet.rds")
...
# Loading Top DEGs with F statistics > 10 (1846 genes)
...
write.csv(overall, file = "results/prediction_degs.csv")